...
import type { Project, Scene, Asset, Job, LedgerSummary } from "@/lib/types";
...
export default function SceneBoard({ projectId }: { projectId: string }) {
  ...
  const { project, scenes, assetsByScene, latestJobByScene, images, finance } = data;
  const allApproved =
      ...
      {images.length > 0 && (
        <div className="card">
          ...
          <p className="muted" style={{ fontSize: 12, marginTop: 4 }}>
            Stills, thumbnails, and edits generated by the image bot.
          </p>
          <div className="divider" />
          <div
            style={{
